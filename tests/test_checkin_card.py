...
from shiguang import ShiguangPlugin  # noqa: E402
from shiguang.checkin import CheckinProfile, CheckinRecord  # noqa: E402
from shiguang.checkin import card as checkin_card  # noqa: E402
from shiguang.checkin.cache import CheckinCardCache  # noqa: E402
from shiguang.checkin.card import (  # noqa: E402
    CardBackground,
    _file_to_data_url,
)
...
class FileToDataUrlTest(unittest.TestCase):
    def test_preserves_validated_source_bytes_mime_dimensions_and_mtime(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            Image.new("RGBA", (750, 1000), (20, 90, 180, 160)).save(source, format="PNG")
...
class CheckinCardRenderQualityTest(unittest.IsolatedAsyncioTestCase):
    async def test_configured_jpeg_quality_is_passed_to_renderer(self):
        plugin = object.__new__(ShiguangPlugin)
        plugin.config = {
            "checkin_avatar_enabled": False,
            "checkin_background_refresh_cost": 100,
            "checkin_card_quality_tier": "清晰",
        }
        plugin._checkin_render_html = AsyncMock(return_value="card.jpg")
        ...
        options = plugin._checkin_render_html.await_args.kwargs["options"]
