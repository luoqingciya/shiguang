...
def resolve_checkin_content(
    ...
    *,
    ...
    context = GreetingContext(
        ...
        user_id_hint="anon-" + hashlib.sha256(record.user_id.encode("utf-8")).hexdigest()[:8],
        ...
        boost_status=(f"好感度奖励 ×{record.boost_multiplier:g}" if record.boost_active else ""),
    ...
    return CheckinContent(
        ...
        secondary_note=_truncate(" · ".join(secondary_notes), limit=MAX_SECONDARY_NOTE_LENGTH),
        context=context,
    )
